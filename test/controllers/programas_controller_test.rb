...
class ProgramasControllerTest < ActionController::TestCase
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post :create, programa: { descripcion: @programa.descripcion, imagen: @programa.imagen, nombre: @programa.nombre, url: @programa.url }
    end
  ...
  test "should update programa" do
    patch :update, id: @programa, programa: { descripcion: @programa.descripcion, imagen: @programa.imagen, nombre: @programa.nombre, url: @programa.url }
    assert_redirected_to programa_path(assigns(:programa))
  end
